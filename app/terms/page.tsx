    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-primary/10">
      <div className="container max-w-3xl py-12">
        ...
        <div className="prose dark:prose-invert">
          ...
          <h2>1. Terms</h2>
          <p>
            By accessing Hello World Universe, you agree to be bound by these
          ...
          <h2>2. Use License</h2>
          <p>
            The code examples provided on Hello World Universe are available for
            educational purposes. You are free to:
          </p>
          <ul>
          ...
          <h2>3. Disclaimer</h2>
          <p>
            The code examples are provided &ldquo;as is&rdquo; without warranty
            of any kind, either expressed or implied.
          </p>

          <h2>4. Limitations</h2>
          <p>
            In no event shall Hello World Universe be liable for any damages
            arising out of the use or inability to use the code examples.
          </p>
